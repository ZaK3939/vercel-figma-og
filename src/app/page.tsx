  ...
  return (
    <main className='mx-auto max-w-xl pt-32 pb-16 px-2 flex flex-col gap-10'>
      <hgroup className='flex flex-col gap-4'>
        <h1 className='text-3xl font-semibold text-gray-800'>Figma to OG Image</h1>
        <p>Create dynamic OG images for your Next.js apps without writing JSX.</p>
      </hgroup>

      <Card
        style={{
          boxShadow: '0 20px 25px -5px rgb(0 0 0/8%), 0 3px 10px -6px rgba(0,0,0,.1)',
        }}
      >
        <CardContent>
          <section className='flex flex-col gap-8 pt-6'>
            <div className='relative aspect-video overflow-hidden rounded-lg'>
              <div className='absolute inset-0 bg-gray-200 animate-pulse grid place-items-center' aria-hidden>
                Generating OG image...
              </div>
              <Image
      ...
      <section className=' text-gray-700'>
        <h2 className='text-2xl font-semibold text-gray-800 mt-12 mb-4'>Getting Started</h2>

        <Header>Installation</Header>
        <p className=''>
          <span className='code'>experimental_FigmaImageResponse</span> is included in{' '}
          <span className='code'>next.js</span>. You will need at least version{' '}
          <span className='code'>next@14.0.5-canary.35</span>.
        </p>

        <Header>Configuration</Header>
        <p className=''>
          Set the environment variable <span className='code'>FIGMA_PERSONAL_ACCESS_TOKEN</span> to your{' '}
          <a href='https://www.figma.com/developers/api#authentication' className='underline'>
        ...
        <p>
          ...
          <a
            ...
            href='https://www.figma.com/file/hPCU9QkipbHm6h1kyMIH3W/FigmaImageResponse-Demo-(Copy)?type=design&node-id=0%3A1&mode=design&t=EDSrd9WxnZYc916m-1'
            target='_blank'
            className='underline'
          >
            Figma design
        ...
        <ul className='list-disc text-base ml-[14px] underline text-gray-700 underline-offset-2'>
          ...
          <li>
            <a href='https://github.com/vercel/example-figma-og-image' target='_blank'>
      ...
      <footer className='flex justify-center'>
        ...
        >
          ...
          <svg viewBox='0 0 284 65' height='1.1em' style={{ marginTop: '2px' }} aria-hidden>
            <path
...
const Header = ({ children }: { children: React.ReactNode }) => {
  return <h3 className='mt-10 mb-2 font-medium text-gray-700 text-sm'>{children}</h3>;
};
...
function highlightedCode(fades: TemplateStringsArray, ...highlighted: string[]) {
